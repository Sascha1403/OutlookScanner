...
from Excel.ExcelSheet import ExcelSheetAbruf
from PDF.Files import PDF
from Message import Typ
...
path_Test_Sheet = '/TestDocuments/test.xlsx'
...
def main():
    ...
    for message in messages:
        ...
        # get Message Type 
        message_Typ = Typ.get_Message_Typ(message)
        ...
        if message_Typ == 'Abruf HIL' and test_Abruf == True:
            ...
            for attached in message.Attachments:
                pdf_Wareneingang = PDF.Wareneingang(message, attached)
